...
import com.folioreader.util.HtmlUtil;
...
public class FolioPageFragment extends Fragment {
     ...
     * 判断插入解析MathML的JS的方法
     */
    private void insertMathJS() {
        if (mHtmlContent.contains("<math") || mHtmlContent.contains("<m:math")) {
            // Use Cloud MATHJS
            mHtmlContent = HtmlUtil.htmlByInjectingIntoHead(mHtmlContent, INJECT_HEAD_CLOUD_MATHJAX);
//            Log.d(TAG, "Util:" + mHtmlContent);
        }
    }
