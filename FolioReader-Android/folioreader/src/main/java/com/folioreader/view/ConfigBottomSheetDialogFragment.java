...
//        int day = getResources().getColor(R.color.white);
        int day = ContextCompat.getColor(getContext(), R.color.white);
        int night = ContextCompat.getColor(getContext(), R.color.night);
        int darkNight = ContextCompat.getColor(getContext(), R.color.dark_night);
